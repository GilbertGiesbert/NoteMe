...
/**
 * The dragDrop listview is an extension of listview that supports cell dragging
 * and swapping.
 *
 ...
 */
public class DragDropListView<Z> extends ListView {

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;

    public ArrayList<Z> itemList;
    ...
    public void setItemList(ArrayList<Z> itemList) {
